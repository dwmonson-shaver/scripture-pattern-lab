...
const SAMPLE: QueryNLResponse = {
  ...
  result: {
    ...
    contextualization: {
      observed_count: 2,
      node_baselines: [
        { node_index: 0, node_type: 'concept', node_value: 'faith', resolved_lemmas: ['πίστις'], count: 483 },
        { node_index: 1, node_type: 'concept', node_value: 'hope', resolved_lemmas: ['ἐλπίς'], count: 84 },
        { node_index: 2, node_type: 'concept', node_value: 'love', resolved_lemmas: ['ἀγάπη'], count: 259 },
      ],
      alternative_orderings: [
        { permutation: [0, 1, 2], sequence_label: 'faith > hope > love', count: 2, is_observed: true },
        { permutation: [0, 2, 1], sequence_label: 'faith > love > hope', count: 0, is_observed: false },
        { permutation: [1, 0, 2], sequence_label: 'hope > faith > love', count: 0, is_observed: false },
        { permutation: [1, 2, 0], sequence_label: 'hope > love > faith', count: 0, is_observed: false },
        { permutation: [2, 0, 1], sequence_label: 'love > faith > hope', count: 0, is_observed: false },
        { permutation: [2, 1, 0], sequence_label: 'love > hope > faith', count: 0, is_observed: false },
      ],
